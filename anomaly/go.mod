module github.com/wolfee-watcher/anomaly-detector
...
require github.com/wolfee-watcher/pkg/mtls v0.0.0
...
require github.com/wolfee-watcher/pkg/httputil v0.0.0

replace github.com/wolfee-watcher/pkg/httputil => ../pkg/httputil
